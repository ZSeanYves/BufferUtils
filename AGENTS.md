...
- In the toplevel directory, this is a `moon.mod` file listing the module and
  dependency metadata. Legacy repositories may still use `moon.mod.json` and
  should migrate it before adding new configuration.
